...
| TWM-12 | **Fixture:** a direção está aprovada e resta condensar um grande volume de textos; custo e latência são requisitos materiais. | Permitir a rota econômica documentada, com Luna no menor effort que preserve consistência durante a transformação delimitada e verificável. | Recomendar Luna apenas porque a direção foi aprovada, sem relacionar a escolha a custo, latência, volume e verificação barata, ou declarar equivalência ao baseline de conversa. |
